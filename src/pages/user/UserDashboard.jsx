    ...
    return (
        <Layout>
            <div className=" container mx-auto px-4 py-5 lg:py-8">
                {/* Top  */}
                <div className="relative top w-1/2 left-80">
                    {/* main  */}
                    <div className=" py-5 rounded-xl shadow-lg flex flex-col gap-3">
                        {/* image  */}
                        <div className="flex justify-center ">
                            <img src="/man.png" alt="logo" className="w-20"/>
                        </div>
                        {/* text  */}
                        <div className="">
                ...
                <div className="bottom">
                    ...
                    <div className="mx-auto my-4 max-w-6xl px-2 md:my-6 md:px-0">
                        ...
                        {/* main 2 */}
                        <div className="mt-5 flex flex-col overflow-hidden rounded-xl md:flex-row border shadow-xl border-[#00ADB5]">
                            {/* main 3  */}
                            <div className="w-full border-r border-[#00ADB5] bg-[#3af5ff1c] md:max-w-xs">
                                {/* left  */}
                                <div className="p-8">
